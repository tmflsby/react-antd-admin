...
const Tencent = () => {
  return (
    <ReactQMap apiKey='UN6BZ-MP2W6-XWCSX-M2ATU-QORGZ-OWFOE' center={{latitude: 30.53786, longitude: 104.07265}}
               initialOptions={{zoomControl: true, mapTypeControl: true}} style={{height: 500}}
               mySpot={{latitude: 30.53786, longitude: 104.07265}} getContainer={getContainer}
    />
  );
};
