...
class Modals extends Component {
  ...
  handleOk2 = () => {
    ...
    this.handleOk2Timer = setTimeout(() => {
      this.setState({
        visible2: false,
  ...
  handleOk3 = () => {
    ...
    this.handleOk3Timer = setTimeout(() => {
      this.setState({
        loading3: false,
        visible3: false
      });
  ...
  componentWillUnmount() {
    clearTimeout(this.handleOk2Timer);
    clearTimeout(this.handleOk3Timer);
  }
            ...
            <div className="gutter-box">
              <Card bordered={false}>
                ...
                <p>
                  ...
                  <Modal title="Title of the modal dialog" visible={this.state.visible2}
                ...
                <p>
                  ...
                  <Modal title="Title" visible={this.state.visible3}
                         onOk={this.handleOk3} onCancel={this.handleCancel3}
                         footer={[
                           <Button key="back" size="large" onClick={this.handleCancel3}>
                             Return
                           </Button>,
                ...
                <p>
                  ...
                  <Modal title="20px to Top" style={{ top: 20 }}
                  ...
                  <Modal title="Vertically centered modal dialog" wrapClassName="vertical-center-modal"
