          ...
          <Col className='gutter-row' md={24}>
            <div className="gutter-box">
              <Card title='富文本编辑器' bordered={false}>
                <Editor editorState={this.state.editorState} toolbarClassName='home-toolbar'
                        wrapperClassName='home-wrapper' editorClassName='home-editor'
                        onEditorStateChange={this.onEditorStateChange}
                        onContentStateChange={this.onEditorChange} spellCheck
                        toolbar={{
